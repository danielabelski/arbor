        ...
        let cwd = match env::current_dir() {
            ...
            Err(error) => {
                ...
                let app = Self {
                    ...
                    terminal_follow_output_active: false,
                    pending_terminal_follow_scroll: false,
                    terminal_follow_output_until: None,
                    last_terminal_follow_scroll_max_offset_y: None,
                    last_terminal_scroll_offset_y: None,
                    last_terminal_scroll_max_offset_y: None,
                    last_active_terminal_visible_signature_session_id: None,
                    last_active_terminal_visible_signature: None,
